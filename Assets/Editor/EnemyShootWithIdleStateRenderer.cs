...
[CustomEditor(typeof(EnemyBodyShootWithStopChecker))]
public class EnemyShootWithStopStateRenderer : Editor {

	private EnemyBodyShootWithStopChecker selectedCheckerInfo;

	private void OnSceneGUI ()
	{
		#if UNITY_EDITOR
		selectedCheckerInfo = target as EnemyBodyShootWithStopChecker;
	...
	private static void CheckChange (int index, EnemyBodyShootWithStopChecker shootChecker, Vector3 point)
	{
	...
	public static void DrawShootableRect (EnemyBodyShootWithStopChecker shootChecker)
	{
